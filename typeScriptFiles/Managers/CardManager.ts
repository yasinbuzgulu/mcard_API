...
export class CardManager {
    ...
    static createCardObject() {
        ...
        if (!!Verifications.checkCardExistence(myApplicant, checkedCity, DataStorage.cards)) {
            cardIdendity = Verifications.checkCardExistence(myApplicant, checkedCity, DataStorage.cards);
        } else {
            cardIdendity = Math.floor(Math.random() * 100000000);
        }
